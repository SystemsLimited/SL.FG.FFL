...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IRRecommendationForm.ascx.cs" Inherits="SL.FG.FFL.WebParts.IRRecommendationForm.IRRecommendationForm" %>
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <div id="printableArea">
                        ...
                        <div class="form-group row" id="waivedTargetDate2_div" runat="server" visible="false">
                            <div class="col-lg-6">
                                <div class="form-group">
...
<script type="text/javascript">
    function isActionConfirmed(action) {
        ...
        var message = "IIR Recommendation: Are you sure you want to perform this action?";
        var flag = false;
    ...
    function printContent() {
        ...
        popupWindow.document.write('<TITLE>Recommendation Form</TITLE>\n');
