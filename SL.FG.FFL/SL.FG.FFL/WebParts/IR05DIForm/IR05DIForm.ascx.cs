...
namespace SL.FG.FFL.WebParts.IR05DIForm
{
    ...
    public partial class IR05DIForm : WebPart
    {
        ...
        protected bool UpdateIR_5Values(List<IRRRecommendation_OnJob> recommendations, SPListItem IR5Item, Boolean IsSaveAsDraft, SPWeb oWebSite, Boolean ApprovingAuthority, Boolean ApprovingAuthorityApprove, Boolean HSEApprove, String[] pattern1, String[] pattern2)
        {
            bool isSaved = true;
            try
            {
                    ...
                    using (SPWeb oSPWeb = oSPsite.OpenWeb())
                    {
                        ...
                        if (IR_1InfoList != null)
                        {
                            ...
                            if (IR5Item != null)
                            {
                                ...
                                List<IRRRecommendation_OnJob> lstRecommendation = GetFormattedRecommendationsByIRDI_Id(oSPWeb, Convert.ToInt32(IR5ID));
        ...
        private List<IRRRecommendation_OnJob> GetFormattedRecommendationsByIRDI_Id(SPWeb oSPWeb, int IRID)
        {
            try
            {
                string spListName = "IIRRecommendation_OffJob";
                // Fetch the List
