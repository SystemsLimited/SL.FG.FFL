...
namespace SL.FG.FFL.WebParts.FlashReportOnForm
{
    [ToolboxItemAttribute(false)]
    public partial class FlashReportOnForm : WebPart
    {
                    ...
                    using (SPWeb oWebSite = oSPsite.OpenWeb())
                    {
                        ...
                        if (oWebSite != null)
                        {
                            ...
                            if (ActionRequiredIndex == 0)
                            {
                                ...
                                IR_1Link = Utility.GetRedirectUrl("IR01DIFormLink");
                                subject = Utility.GetValueByKey("TeamIR01DIEmailSubject");
                                body = Utility.GetValueByKey("TeamIR01DIEmailTemplate");
                            }
                            else
                            {
                                listName = "IR03DI";

                                IR_1Link = Utility.GetRedirectUrl("IR03DIFormLink");
                                subject = Utility.GetValueByKey("TeamIR03DIEmailSubject");
                                body = Utility.GetValueByKey("TeamIR03DIEmailTemplate");
                            }
