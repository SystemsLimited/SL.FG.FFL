...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FlashReportOffForm.ascx.cs" Inherits="SL.FG.FFL.WebParts.FlashReportOffForm.FlashReportOffForm" %>
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <div class="form-group row">
                        <div class="col-lg-4">
                            <label>Flash Report ID:<span class="col-lg-12" id="FRID_spn" runat="server"></span></label>


                        </div>
                        <div class="col-lg-6">
                            <label><span class="col-lg-12" id="header_spn" runat="server"></span></label>
                        </div>
                        <div class="col-lg-2">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <asp:DropDownList ID="ActionRequired_Unit_ddl" runat="server" CssClass="form-control" AutoPostBack="false">
                                                <asp:ListItem>IR-5 Filled</asp:ListItem>
                                            </asp:DropDownList>
