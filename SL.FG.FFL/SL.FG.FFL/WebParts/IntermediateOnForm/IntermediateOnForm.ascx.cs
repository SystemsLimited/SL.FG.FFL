...
namespace SL.FG.FFL.WebParts.IntermediateOnForm
{
    [ToolboxItemAttribute(false)]
    public partial class IntermediateOnForm : WebPart
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.FFL(IntermediateOnForm->Page_Load)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
            }
        }
        ...
        protected void AddDummyEntryInIR01ListToAssignTaskTo(SPWeb oWebSite, SPListItem IR02ListItem)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.FFL(IntermediateOnForm->AddDummyEntryInIR01ListToAssignTaskTo)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
            }
        }
    }
}
